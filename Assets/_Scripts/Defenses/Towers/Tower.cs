...
public class Tower : MonoBehaviour, IDamageable {
    ...
    public void shootUnit() {
        ...
        projectile.GetComponent<TowerProjectile>().points.Add(shootingLocation.transform.position);
        projectile.GetComponent<TowerProjectile>().points.Add(findInterpolationVector(target.transform.position));
        projectile.GetComponent<TowerProjectile>().points.Add(target.transform.position);
        projectile.GetComponent<TowerProjectile>().targetObject = target;
    }
